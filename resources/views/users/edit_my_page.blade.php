              ...
              <div class="row form-group mb-0">
                  <div class="col-md-6">
                      <div class="input-group">
                        ...
                        <input class="form-control datepicker" @if (auth()->user()->birthdate_changed == 'yes') disabled @endif name="birthdate" placeholder="{{trans('general.birthdate')}} *"  value="{{auth()->user()->birthdate}}" autocomplete="off" type="text">
                      </div>
                      <small class="form-text text-muted mb-4">{{ trans('general.valid_formats') }} <strong>01/31/2000</strong> --
...
$('.datepicker').datepicker({
    ...
    endDate: '{{ now()->subYears(18)->format('m/d/Y') }}',

  ...
  public function profile($slug, $media = null)
  {
    ...
    // Stripe Key
      ...
      $plans = $user->plans()
        ...
        $userPlanMonthlyActive = $user->plans()->whereStatus('1')->first();
  ...
  public function postDetail($slug, $id)
  {
	...
	Validator::extend('letters', function($attribute, $value, $parameters){
      ...
      $validator = Validator::make($input, [
        ...
        'address' => 'max:100',
        'zip' => 'max:20',
        'birthdate' => 'required_if:is_birthdateChanged,==,0|date|before:'.Carbon::now()->subYears(18),
     ], $messages);
      ...
      $user->birthdate       = auth()->user()->birthdate_changed == 'no' ? $this->request->birthdate : auth()->user()->birthdate;
